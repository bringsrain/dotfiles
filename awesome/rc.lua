...
--beautiful.init("/home/bringsrain/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Tag names
    local tagnames = beautiful.tagnames or { "Main", "Web", "Telegram", "Music", "Misc", "6", "7", "8", "9" }
...
-- autostart
awful.spawn.with_shell("~/.config/awesome/bin/autostart.sh")
